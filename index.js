...
// const superbowlWin = record.map((records) => {
//     if(records.year === "1969") {
//         return "KC Chiefs won the superbowl'"
//     }
// })

function superbowlWin(record){
  let theYearRecord  = record.find((winningYear) => {
      return  winningYear.result === "W"
  })

  if ( theYearRecord ) {
      return theYearRecord.year
  }
  return undefined
}
